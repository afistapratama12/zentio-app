              ...
              {budgetHistory.map((history, index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    >
                      <h4 className="font-semibold text-lg text-gray-900 hover:text-emerald-600 flex items-center gap-2">
                    ...
                    <div className="flex items-start gap-6">
                      <div>
                        <Link href={`/app/create-budget?sessionId=${history.id}`}>
                          <Button
                            className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white hover:cursor-pointer"
                          >Detail</Button>
                        </Link>
                      </div>
